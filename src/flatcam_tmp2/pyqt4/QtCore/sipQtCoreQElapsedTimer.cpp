...
#line 29 "/home/bcthund/OneDrive/Projects/github/flatcam_installer/src/flatcam_tmp2/pyqt4/QtCore/sipQtCoreQElapsedTimer.cpp"
...
static sipEnumMemberDef enummembers_QElapsedTimer[] = {
    {sipName_MachAbsoluteTime, static_cast<int>( ::QElapsedTimer::MachAbsoluteTime), 51},
    {sipName_MonotonicClock, static_cast<int>( ::QElapsedTimer::MonotonicClock), 51},
    {sipName_PerformanceCounter, static_cast<int>( ::QElapsedTimer::PerformanceCounter), 51},
    {sipName_SystemTime, static_cast<int>( ::QElapsedTimer::SystemTime), 51},
    {sipName_TickCounter, static_cast<int>( ::QElapsedTimer::TickCounter), 51},
};
