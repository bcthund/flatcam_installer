...
_pkg_config = {
    ...
    'pyqt_config_args':  '',
    'pyqt_mod_dir':      '/usr/lib/python2.7/dist-packages/PyQt4',
    'pyqt_modules':      'QtCore',
    'pyqt_sip_dir':      '/usr/share/sip/PyQt4',
    'pyqt_sip_flags':    '-n PyQt4.sip -x VendorID -t WS_X11 -x PyQt_NoPrintRangeBug -t Qt_5_0_0 -x Py_v3 -g',
    'pyqt_version':      0x040c03,
    'pyqt_version_str':  '4.12.3',
    'qt_archdata_dir':   '/usr/lib/x86_64-linux-gnu/qt5',
...
_default_macros = {
    ...
    'CFLAGS_CONSOLE':           '',
    'CFLAGS_DEBUG':             '-g',
    'CFLAGS_EXCEPTIONS_OFF':    '-fno-exceptions',
