...
#line 29 "/home/bcthund/OneDrive/Projects/github/flatcam_installer/src/flatcam_tmp/pyqt4/QtCore/sipQtCoreQStringMatcher_0.cpp"

#line 27 "/home/bcthund/OneDrive/Projects/github/flatcam_installer/src/flatcam_tmp/pyqt4/sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "/home/bcthund/OneDrive/Projects/github/flatcam_installer/src/flatcam_tmp/pyqt4/QtCore/sipQtCoreQStringMatcher_0.cpp"
#line 26 "/home/bcthund/OneDrive/Projects/github/flatcam_installer/src/flatcam_tmp/pyqt4/sip/QtCore/qnamespace.sip"
#include <qnamespace.h>
#line 36 "/home/bcthund/OneDrive/Projects/github/flatcam_installer/src/flatcam_tmp/pyqt4/QtCore/sipQtCoreQStringMatcher_0.cpp"
...
static PyObject *meth_QStringMatcher_0_setPattern(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_QStringMatcher, sipName_setPattern, SIP_NULLPTR);
...
static PyObject *meth_QStringMatcher_0_setCaseSensitivity(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QStringMatcher, sipName_setCaseSensitivity, SIP_NULLPTR);
...
static PyObject *meth_QStringMatcher_0_indexIn(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ1|i", &sipSelf, sipType_QStringMatcher, &sipCpp, sipType_QString,&a0, &a0State, &a1))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QStringMatcher, sipName_indexIn, SIP_NULLPTR);
...
static PyObject *meth_QStringMatcher_0_pattern(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QStringMatcher, sipName_pattern, SIP_NULLPTR);
...
static PyObject *meth_QStringMatcher_0_caseSensitivity(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QStringMatcher, sipName_caseSensitivity, SIP_NULLPTR);
...
extern "C" {static void assign_QStringMatcher_0(void *, SIP_SSIZE_T, void *);}
static void assign_QStringMatcher_0(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::QStringMatcher *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::QStringMatcher *>(sipSrc);
}
...
{
     ::QStringMatcher *sipCpp = SIP_NULLPTR;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_QStringMatcher, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_QStringMatcher_0[] = {
    {SIP_MLNAME_CAST(sipName_caseSensitivity), meth_QStringMatcher_0_caseSensitivity, METH_VARARGS, SIP_NULLPTR},
    {SIP_MLNAME_CAST(sipName_indexIn), SIP_MLMETH_CAST(meth_QStringMatcher_0_indexIn), METH_VARARGS|METH_KEYWORDS, SIP_NULLPTR},
    {SIP_MLNAME_CAST(sipName_pattern), meth_QStringMatcher_0_pattern, METH_VARARGS, SIP_NULLPTR},
    {SIP_MLNAME_CAST(sipName_setCaseSensitivity), meth_QStringMatcher_0_setCaseSensitivity, METH_VARARGS, SIP_NULLPTR},
    {SIP_MLNAME_CAST(sipName_setPattern), meth_QStringMatcher_0_setPattern, METH_VARARGS, SIP_NULLPTR}
};
