...
#if PY_MAJOR_VERSION >= 3
    PyObject *sip_flags = PyUnicode_FromString("-n PyQt4.sip -x VendorID -t WS_X11 -x PyQt_NoPrintRangeBug -t Qt_5_0_0");
#else
    PyObject *sip_flags = PyString_FromString("-n PyQt4.sip -x VendorID -t WS_X11 -x PyQt_NoPrintRangeBug -t Qt_5_0_0");
#endif
